...
class SubscriptionManager:
    ...
    @staticmethod
    def create_subscription(subscription_create_dto): # dto stands for data transfer object
        ...
        current_period_started_at = subscription_create_dto.get('current_period_started_at')
